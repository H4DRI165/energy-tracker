...
class UsageState {
  ...
  List<ChargeLineItem> get domesticChargeBreakdown =>
      TariffRates.domesticBreakdown(currentKwh);

  List<TierBreakdown> get commercialTierBreakdown =>
      TariffRates.breakdownFor(currentKwh, TariffType.commercial);
